    ...
    <div class="dashboard-wrapper">
        ...
        <div class="card">
            ...
            <form action="content_dashboard.php" method="POST" enctype="multipart/form-data">
                ...
                <button type="submit" name="create_content" class="btn btn-primary">Create Content</button>
            </form>
        </div>
                    ...
                    <?php else: ?>
                        <?php foreach ($allContent as $item): ?>
                            <tr id="content-row-<?php echo $item['id']; ?>">
                                ...
                                <td>
                                    <a href="../view.php?id=<?php echo $item['id']; ?>" target="_blank">View</a> |
                                    <a href="edit_content.php?id=<?php echo $item['id']; ?>">Edit</a> |
                                    <a href="#" class="action-link-delete" data-id="<?php echo $item['id']; ?>">Delete</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
